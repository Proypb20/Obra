...
export class UnidadMedidaComponent implements OnInit {
  ...
  trackId = (_index: number, item: IUnidadMedida): number => this.unidadMedidaService.getUnidadMedidaIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.unidadMedidas = this.refineData(dataFromBody);
  }
